...
(function initSiteNav() {
  ...
  headerStart += '<a href="/docs/site/index.html" class="site-header-logo">'
  ...
  var headerEnd = '<div class="site-header-end">'
  ...
  if (hasSidebar) {
    ...
    sidebarHtml = '<dialog id="site-nav-drawer" class="site-sidebar drawer" data-placement="start" aria-label="Site navigation">'
      ...
      + '<a href="/docs/site/index.html" class="sidebar-nav-link sidebar-nav-home" data-access="team" aria-label="Home" data-tooltip="Home" data-tooltip-position="right">'
      + '<div class="svg-icn">' + ICON_HOME + '</div>'
      + '<span>Home</span>'
      + '</a>'
      + `<details class="sidebar-nav-section">
      <summary class="sidebar-nav-section-toggle" aria-label="Brand" data-tooltip="Brand" data-tooltip-position="right">
        <span>Brand</span>
        <span class="sidebar-nav-toggle-icon">
          <svg width="6" height="6" viewBox="0 0 6 6" fill="none" aria-hidden="true">
            <path d="M3.58943 3L1.28943 0.7L1.98943 0L4.98943 3L1.98943 6L1.28943 5.3L3.58943 3Z" fill="currentColor"/>
          </svg>
        </span>
      </summary>
      <ul class="sidebar-nav-list"><li><a href="/docs/site/brand-book.html" class="sidebar-nav-link" data-section="brand" data-order="1" data-access="team"><span>Brand Book</span></a></li></ul></details><details class="sidebar-nav-section">
      <summary class="sidebar-nav-section-toggle" aria-label="Content" data-tooltip="Content" data-tooltip-position="right">
        <span>Content</span>
        <span class="sidebar-nav-toggle-icon">
          <svg width="6" height="6" viewBox="0 0 6 6" fill="none" aria-hidden="true">
            <path d="M3.58943 3L1.28943 0.7L1.98943 0L4.98943 3L1.98943 6L1.28943 5.3L3.58943 3Z" fill="currentColor"/>
      ...
      <ul class="sidebar-nav-list"><li><a href="/docs/site/seo-best-practices.html" class="sidebar-nav-link" data-section="content" data-order="1" data-access="team"><span>SEO</span></a></li><li><a href="/docs/site/markdown-style.html" class="sidebar-nav-link" data-section="content" data-order="2" data-access="team"><span>Markdown</span></a></li></ul></details><details class="sidebar-nav-section">
      <summary class="sidebar-nav-section-toggle" aria-label="Project" data-tooltip="Project" data-tooltip-position="right">
        <span>Project</span>
        <span class="sidebar-nav-toggle-icon">
          <svg width="6" height="6" viewBox="0 0 6 6" fill="none" aria-hidden="true">
            <path d="M3.58943 3L1.28943 0.7L1.98943 0L4.98943 3L1.98943 6L1.28943 5.3L3.58943 3Z" fill="currentColor"/>
      ...
      <ul class="sidebar-nav-list"><li><a href="/docs/site/setup.html" class="sidebar-nav-link" data-section="project" data-order="1" data-access="team"><span>Setup</span></a></li><li><a href="/docs/site/template.html" class="sidebar-nav-link" data-section="project" data-order="2" data-access="team"><span>Template</span></a></li><li><a href="/docs/site/folder-structure.html" class="sidebar-nav-link" data-section="project" data-order="3" data-access="team"><span>Folders</span></a></li><li><a href="/docs/site/upgrading-docs.html" class="sidebar-nav-link" data-section="project" data-order="4" data-access="team"><span>Upgrading the Docs Engine</span></a></li></ul></details>`
      + '</div>'
      + '</dialog>';
  }
